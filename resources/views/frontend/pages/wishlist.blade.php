...
@section('title','AUTOZONE-SHOP || Liste des Souhaits')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Liste des souhaits</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							@if(Helper::getAllProductFromWishlist()->isNotEmpty())
							...
							@else
								<tr>
									<td class="text-center">
										Il n'y a pas de produits dans la liste des souhaits. <a href="{{route('product-grids')}}" style="color:blue;">Continuez vos achats.</a>
