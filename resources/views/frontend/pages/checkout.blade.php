...
@section('title','AUTOZONE-SHOP || Page de paiement')
        ...
        <div class="container">
            <form class="form" method="POST" action="{{ route('cart.order') }}">
                ...
                <div class="row">
                    <div class="col-lg-8 col-12">
                        <div class="checkout-form">
                            <h2>Procédez au paiement ici</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="country" id="country" disabled value="Maroc">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="order-details">
                            ...
                            <div class="single-widget">
                                ...
                                <div class="content">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">Prix sans
                                            livraison<span>${{ number_format(Helper::totalCartPrice(), 2) }}</span></li>
                                        <li class="shipping">
                                            Frais de livraison
                                            @if (count(Helper::shipping()) > 0 && Helper::cartCount() > 0)
                                                <select name="shipping" class="nice-select">
                                        ...
                                        @if (session('coupon'))
                                            <li class="coupon_price" data-price="{{ session('coupon')['value'] }}">Vous
                                                économisez<span>${{ number_format(session('coupon')['value'], 2) }}</span>
                                            </li>
                                        @endif
                                        @php
                                            $total_amount = Helper::totalCartPrice();
                            ...
                            <div class="single-widget">
                                ...
                                <div class="content">
                                    <div class="checkbox">
                                        ...
                                        <form-group>
                                            <input name="payment_method" type="radio" value="cod" selected> <label>
                                                Paiement à la livraison</label><br>
                                            {{-- <input name="payment_method"  type="radio" value="paypal"> <label> PayPal</label> --}}
                                        </form-group>
                                    </div>
                                </div>
                            ...
                            <!--/ Fin du widget Commande -->
                            <!-- Widget Mode de paiement -->
                            <div class="single-widget payement">
                                <div class="content">
                                    <img src="{{ 'backend/img/payment-method.png' }}" alt="#">
                                </div>
                            </div>
                            <!--/ Fin du widget Mode de paiement -->
                            <!-- Widget Bouton -->
                            <div class="single-widget get-button">
                                <div class="content">
                                    <div class="button">
