...
@endsection
@section('title', 'AUTOZONE-SHOP || DETAIL DU PRODUIT')
                            ...
                            <div class="product-des">
                                ...
                                <div class="short">
                                    ...
                                    <div class="rating-main">
                                        ...
                                        <a href="#stock" id="top_avis"
                                            class="total-review">({{ $product_detail['getReview']->count() }}) Avis</a>
                                    </div>
                                    @php
                                        $after_discount =
                                    ...
                                    @endphp
                                    <p class="price"><span class="discount">{{ number_format($after_discount, 2) }}
                                            DH</span>
                                ...
                                <div class="product-buy">
                                    ...
                                    @endif
                                    <p class="availability" id="stock">Stock : @if ($product_detail->stock > 0)
                                ...
                                <div class="nav-main">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#reviews"
                                                role="tab" id="avis">Avis</a></li>
                                    </ul>
                                    <!--/ Fin Onglets de navigation -->
                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="comment-review">
                                                        <div class="add-review">
                                                            ...
                                                            <p>Votre adresse e-mail ne sera pas publiée. Les champs
                                                                obligatoires sont indiqués par <span
...
@push('scripts')
    ...
    <script>
        $('#top_avis').click(function() {
            $('#avis').click();
            if (this.hash !== "") {
                // Prévenir le comportement par défaut du clic de lien
                event.preventDefault();
                // Stocker la valeur de hash
                var hash = this.hash;
                // Utilisez jQuery pour l'animation de défilement
                $('html, body').animate({
                    scrollTop: $(hash).offset().top
                }, 800, function() {
                    // Ajoutez le hash (#) à l'URL lorsque le défilement est terminé (par exemple, pour maintenir la position de défilement de la page)
